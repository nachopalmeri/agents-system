---
name: x-content-strategist
description: "Use for X/Twitter content strategy: post ideas, threads, hooks, calendar and diagnosing underperforming posts."
---

> Ex agente `agente-x-content-strategist` (convertido en skill el 2026-09-24).

# Estrategia de contenido para X
